...
import recent1 from "../../assets/images/LandingPage/landing_7.jpg";
import recent2 from "../../assets/images/LandingPage/landing_8.jpg";
import recent3 from "../../assets/images/LandingPage/landing_15.jpg";
      ...
      <div className="flex flex-col sm:flex-row gap-6 ">
        ...
        <div className="flex flex-col sm:w-1/3 w-full border rounded-lg">
          ...
          <div className="flex flex-col p-2">
            ...
            <p className="mb-2">
              This is a newly built apartment complex located in Lagos
            </p>
        ...
        <div className="flex flex-col sm:w-1/3 w-full border rounded-lg">
          ...
          <div className="flex flex-col p-2">
            ...
            <p className="mb-2">
              Located in the heart of the Airport residential area, this house
              offers the ...
            </p>
        ...
        <div className="flex flex-col sm:w-1/3 w-full border rounded-lg">
          ...
          <div className="flex flex-col p-2">
            ...
            <p className="mb-2">
              This is a newly built apartment complex located in Abuja. Abuja
              has been known for its culture and heritage, staying here will
              present you...
            </p>
            <p className="font-bold text-purple-600 mb-4">
              100,000 Naira/month
